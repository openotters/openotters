module github.com/openotters/openotters

go 1.26.2

require (
	charm.land/catwalk v0.37.6
	...
	github.com/openotters/agentfile v1.0.0-alpha.37
	github.com/openotters/bin v1.0.0-alpha.8
